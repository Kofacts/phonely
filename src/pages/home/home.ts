...
import { HomecontentsPage } from '../homecontents/homecontents';
...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, public statusBar: StatusBar, public admob: AdMobFree, public contactsD: Contacts, public popoverCtrl: PopoverController, public actionCtrl: ActionSheetController, private callNumber: CallNumber) {
  	this.fetchContacts();
  ...
  showBanner() {
        ...
        let bannerConfig: AdMobFreeBannerConfig = {
            ...
            autoShow: true,
            id: 'ca-app-pub-8763390762154228/8451209396'
        };
